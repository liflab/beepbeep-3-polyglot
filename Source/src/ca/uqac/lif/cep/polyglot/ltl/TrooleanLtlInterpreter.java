...
public abstract class TrooleanLtlInterpreter extends GroupProcessorBuilder
{
  ...
  protected String getGrammar()
  {
    return ca.uqac.lif.cep.polyglot.Util
        .convertStreamToString(TrooleanLtlInterpreter.class.getResourceAsStream("core.bnf"));
  }
  ...
  {
    return handleBinaryFunction(Troolean.IMPLIES_FUNCTION, (Processor) procs[0],
        (Processor) procs[1]);
  }
