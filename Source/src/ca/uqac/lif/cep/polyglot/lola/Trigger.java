...
/**
 * A trigger is a sink that is instructed to notify another object whenever it
 * receives an input event. This is done by passing to it an instance of some
 * object that implements the {@link Triggerable} interface.
 * <p>
 * As its name implies, this processor mimics the <tt>trigger</tt> construct in
 * the Lola language.
 * 
...
public class Trigger extends Sink
{
   ...
   * 
   * @param t
   *          The object that gets notified by the trigger when it receives an
   *          input
   */
